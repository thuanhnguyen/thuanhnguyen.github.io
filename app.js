$(function(){
    ...
    $('.logo').click(function (e) { 
        e.preventDefault();
        $('body').animate({scrollTop:$('.khoi1').offset().top - 72}, 1000);
    });

    $('.menu1').click(function (e) { 
        e.preventDefault();
        $('body').animate({scrollTop:$('.khoi2').offset().top - 72}, 1000);
    });

    $('.menu2').click(function (e) { 
        e.preventDefault();
        $('body').animate({scrollTop:$('.khoi3').offset().top - 72}, 1000);
    });

    $('.menu3').click(function (e) { 
        e.preventDefault();
        $('body').animate({scrollTop:$('.khoi4').offset().top - 72}, 1000);
    });
